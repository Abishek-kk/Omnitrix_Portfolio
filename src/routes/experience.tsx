...
export const Route = createFileRoute("/experience")({
  head: () => ({
    meta: [
      { title: "Experience — Abishek Portfolio" },
      ...
      <div className="grid lg:grid-cols-[1fr_280px] gap-4">
        ...
        >
          <Panel>
            ...
            <motion.div
              className="relative space-y-5 mt-4"
              variants={{
                hidden: {},
            ...
            >
              ...
              {exp.map((e) => (
                <motion.div
                  ...
                  className="grid grid-cols-[auto_auto_1fr] gap-4"
                >
                  ...
                  <motion.div
                    ...
                    whileTap={{ scale: 0.96 }}
                    className="neon-panel rounded-md p-4"
                  >
                ...
                <div className="relative w-32 h-32">
                  <svg viewBox="0 0 100 100" className="w-full h-full -rotate-90">
                    ...
                    <motion.circle cx="50" cy="50" r="42" fill="none" stroke="var(--neon)" strokeWidth="6" strokeLinecap="round"
                      ...
                      whileInView={{ strokeDashoffset: 2 * Math.PI * 42 * 0.75 }}
                      viewport={{ once: true }}
