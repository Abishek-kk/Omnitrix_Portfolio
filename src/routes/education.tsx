        ...
        <Panel className="p-4">
          ...
          <div className="space-y-4 relative">
            ...
            {journey.map((j) => {
              const Icon = j.icon;
              return (
                <div key={j.title} className="grid grid-cols-[auto_auto_1fr_auto] gap-4 items-start">
                  ...
                  <div className="neon-panel rounded-md p-3">
                  ...
                  <div className="neon-panel rounded-md p-2 w-48 hidden lg:block">
          ...
          <Panel>
            ...
            <div className="grid grid-cols-5 gap-2">
              {learnings.map((l) => {
                const Icon = l.icon;
                return (
                  <div key={l.label} className="flex flex-col items-center gap-2 hex-clip bg-neon/5 p-2 border border-neon/30">
